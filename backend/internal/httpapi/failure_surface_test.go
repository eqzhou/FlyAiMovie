...
func TestBusinessEndpointsReturnStableClientErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodDelete, "/api/v1/episodes/999", "", http.StatusNotFound},
		{http.MethodDelete, "/api/v1/episodes/bad", "", http.StatusBadRequest},
		{http.MethodPost, "/api/v1/episodes/999/copy", `{}`, http.StatusNotFound},
		{http.MethodPost, "/api/v1/episodes/bad/copy", `{}`, http.StatusBadRequest},
		{http.MethodPost, "/api/v1/episodes/999/move", `{"direction":"up"}`, http.StatusNotFound},
		{http.MethodPost, "/api/v1/episodes/bad/move", `{"direction":"up"}`, http.StatusBadRequest},
		{http.MethodPost, "/api/v1/episodes/1/move", `{"direction":"sideways"}`, http.StatusBadRequest},
		...
		{http.MethodPost, "/api/v1/characters/999/save-to-library", `{}`, http.StatusNotFound},
		{http.MethodPost, "/api/v1/characters/bad/save-to-library", `{}`, http.StatusBadRequest},
		...
		{http.MethodPost, "/api/v1/storyboards/999/copy", `{}`, http.StatusNotFound},
		{http.MethodPost, "/api/v1/storyboards/bad/copy", `{}`, http.StatusBadRequest},
		{http.MethodPost, "/api/v1/storyboards/999/move", `{"direction":"up"}`, http.StatusNotFound},
		{http.MethodPost, "/api/v1/storyboards/bad/move", `{"direction":"up"}`, http.StatusBadRequest},
		{http.MethodPost, "/api/v1/storyboards/1/move", `{"direction":"sideways"}`, http.StatusBadRequest},
